...
describe('MCP Server Core Functionality', () => {
  describe('Server Configuration and Tool Definitions', () => {
    ...
    it('should configure server with correct name and version', () => {
      ...
      expect(mcpServerContent).toContain('"workflow-orchestration-server"');
      expect(mcpServerContent).toContain('"0.0.1"');
    });
  ...
  describe('WorkflowOrchestrationServer Class Structure', () => {
