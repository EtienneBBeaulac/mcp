...
> 📚 **Comprehensive documentation for the WorkRail System**

[![Status](https://img.shields.io/badge/status-implementation-green.svg)](https://github.com/EtienneBBeaulac/mcp)
...
- **GitHub Issues**: [Project Issues](https://github.com/EtienneBBeaulac/mcp/issues)
- **Discussions**: [GitHub Discussions](https://github.com/EtienneBBeaulac/mcp/discussions)
- **Wiki**: [Project Wiki](https://github.com/EtienneBBeaulac/mcp/wiki)

### Additional Resources

- **[System Overview](../workrail-mcp-overview.md)** - High-level system overview
- **[MCP Specification](https://modelcontextprotocol.org)** - The protocol this system is based on
---
